...
const Index = () => (
  <div>
    <Head>
      <title>Docker Training, Ondrej Sika - docker-training.at</title>
    </Head>
    <Navigation location={site.location} />
    <Header
      websiteHeader="Docker Training Austria 🇦🇹"
      byName="Ondrej Sika"
      byUrl="https://ondrej-sika.com/?x_source=docker-training.at"
      logoUrl="/static/docker-w.svg"
    >
      <HeaderLink url="mailto:ondrej@sika.io?subject=[docker-training.at] Docker Training Inquiry">
        Request a training
      </HeaderLink>
      <HeaderLink url="https://ondrej-sika.com/contact/?x_source=docker-training.at">
        Contact me
      </HeaderLink>
    </Header>
...
`}
        ...
        <p className="text-center">
          ...
          <a
            href="mailto:ondrej@sika.io?subject=[docker-training.at] Docker Training Inquiry"
