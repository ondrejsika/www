...
const LandingPage = (props) => (
  <BaseLandingPage
    ...
    title={
      {
        en: "SikaLabs - IT Training, Consulting and Workshops in Europe",
        cs: "SikaLabs - IT Školení, konzultace a workshopy"
      }[props.site.lang || "en"]
    }
    headerText={
      <Translate
        ...
        en={
          <>
            We are{" "}
            <BaseLandingPage.TextBeige>SikaLabs</BaseLandingPage.TextBeige>{" "}
            <br />
        ...
        cs={
          <>
            Jsme <BaseLandingPage.TextBeige>SikaLabs</BaseLandingPage.TextBeige>
            <br />a pomůžeme vám s
            <br />
    ...
    boxHeader1={
      <Translate
        ...
        cs="IMPLEMENTUJEME VÁM DEVOPS PIPELINE"
      />
    }
    boxText1={
      <Translate
        lang={props.site.lang}
        en="We will implement open-source DevOps in your company. We will set up tools and processes so that you automatically, reliably and quickly deliver new functionality to your customers."
        cs="Zavedeme open-source DevOps do Vaší firmy. Nastavíme nástroje a procesy tak, abyste automaticky, spolehlivě a rychle doručovali novou funkcionalitu Vašim zákazníkům."
      />
    }
    boxHeader2={
      <Translate
        ...
        cs={<span>PORADÍME A NABÍDNEME SUPPORT BALÍČEK</span>}
      />
    }
    boxText2={
      <Translate
        lang={props.site.lang}
        en="We will solve your specific problem in the form of consultations, thus avoiding unnecessary and expensive mistakes. Me and my team will support you in the operation of your DevOps infrastructure in the form of our support plans."
        cs="Vyřešíme Váš konkrétní problém formou konzultací, čímž se vyvarujete zbytečných a drahých chyb. Budeme Vám oporou při provozu Vaší DevOps infrastruktury formou jednoho z našich support plánů."
      />
    }
    boxHeader3={
      <Translate
        ...
        cs={<span>VYŠKOLÍME VÁŠ TÝM VE VYBRANÉ TECHNOLOGII</span>}
      />
    }
    boxText3={
      <Translate
        lang={props.site.lang}
        en="We will train your team so that they can create a DevOps pipeline and work with it effectively. They will learn everything at hands-on workshops, after which they will be able to safely manage and quickly develop your DevOps environment."
        cs="Vyškolíme Váš tým tak, aby mohl sám a efektivně vytvořit DevOps pipeline a pracovat s ním. Vše si vyzkoušíme na hands-on workshopech, po jejichž absolvování budete schopni bezpečně spravovat a rychle rozvíjet Vaše DevOps prostředí."
      />
    }
    trainingHeader={
      <Translate
    ...
    writeMe={
      <Translate lang={props.site.lang} en="Contact us" cs="Napište nám" />
    }
  />
);
