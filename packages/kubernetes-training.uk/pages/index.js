...
const Index = () => (
  <div>
    ...
    <Header
      websiteHeader="Kuberneres Training UK 🇬🇧"
      byName="Ondrej Sika"
      byUrl="https://ondrej-sika.uk/?x_source=kubernetes-training.uk"
      logoUrl="/static/kubernetes.png"
    >
      <HeaderLink url="mailto:ondrej@sika.io?subject=[kubernetes-training.uk] Kuberneres Training Inquiry">
        Request training
      </HeaderLink>
...
`}
        ...
        <p className="text-center">
          {/* <Link href="https://ondrej-sika.uk/training/kubernetes/inquiry/?x_source=git-training.uk">
            <a className="btn btn-large btn-success">
              Inquire Kubernetes Training
            </a>
          </Link> */}
          <a
            href="mailto:ondrej@sika.io?subject=[kubernetes-training.uk] Kuberneres Training Inquiry"
