...
const Index = () => (
  <div>
    ...
    <Header
      websiteHeader="Ansible Schulung Deutschland 🇩🇪"
      byName="Ondrej Sika"
      byUrl="https://sika-kraml.de/kontakt/?x_source=ansible-schulung.de"
      logoUrl="/static/ansible.png"
    >
      <HeaderLink url="mailto:schulungen@sika-kraml.de?subject=[sika-kraml.de] Ansible Schulung Angebot">
...
Pokud máte zájem o školení, neváhejte mě kontaktovat
        `}
        />
        <ButtonOutline btnUrl="https://ondrej-sika.cz/skoleni/ansible/poptavka/">
          Nezávazně poptat školení
        </ButtonOutline>
      </TextFrame>
