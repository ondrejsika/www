        ...
        <div className="box col-12">
          <div className='row'>
            ...
            <div className='col-8'>
              ...
              <a href='/skoleni/docker'><p className='pb-3 course-text'>Provozujte cokoliv a kdekoliv. Uz necekejte na nastaveni vaseho serveru nebo na aktualizaci nejake knihovny. Mejte prostredi jako soucast vasi aplikace.</p></a>
            </div>
          </div>
        </div>
        <div className="box col-12">
          <div className='row'>
            ...
            <div className='col-8'>
              ...
              <a href='/skoleni/kubernetes'><p className='pb-3 course-text'>Kubernetes je dnes nejpoužívanější orchestrator kontejneru. Pokud chcete vsadit na jistotu pri provozovani Docker kontejneru, zvolte Kubernetes.</p></a>
            </div>
          </div>
        </div>
        <div className="col-12">
          <div className='row'>
            ...
            <div className='col-8'>
              ...
              <a href='/skoleni/git' className='course-text'><p className='pb-3 course-text'>Moderni verzovaci nastroj. Dnes defakto standart a nezbytna soucat kazdeho vyvojarskeho tymu.</p></a>
            </div>
          </div>
        </div>
        <div className="col-12">
          <div className='row'>
            ...
            <div className='col-8'>
              ...
              <a href='/skoleni/gitlab-ci'><p className='pb-3 course-text'>Nástroj na automaticke testovani a automaticke nasazovani integrovane primo v Gitlabu. Testujte kazdy jednotlivi commit a nasazujte stisknutim tlacitka.</p></a>
            </div>
          </div>
        </div>
        <div className="col-12">
          <div className='row'>
            ...
            <div className='col-8'>
              ...
              <a href='/skoleni/ansible'><p className='pb-3 course-text'>Ansible je nástroj na hromadnou správu konfiguraci a nasazování. Vy deklarujete vysledný stav serveru a služeb a Ansible se postará o provedení.</p></a>
            </div>
          </div>
        </div>
      </div>
