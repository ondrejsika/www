    ...
    <Former2 site={site} name='Course inquiry' redirect_path="/odeslano">
      ...
      <div className="form-group">
        ...
        <div className="col-md-4 mb-3 pl-0">
          ...
          <input type="email" className="form-control-border" id="validationDefault03" name="email" placeholder={props.FormEmailPlaceholder} required />
        </div>
        <div className="col-md-4 mb-3 pl-0">
          <label htmlFor="validationDefault04">{props.FormPhone}</label>
          <input type="tel" className="form-control-border" id="validationDefault04" name="phone" placeholder={props.FormPhonePlaceholder} required />
        </div>
      </div>
