...
export default () => (
  <Article
    ...
    markdown={`
Proc by kazdy mel mit email na vlastni domene? Mozna to zni jako overhead, ale mam k tomu par duvodu. Ve zkratce, byt vice nezavysly - svobodnejsi a pro osobni brand.
