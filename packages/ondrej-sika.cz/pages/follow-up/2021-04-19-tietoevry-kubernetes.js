...
const Page = () => (
  <Article
    title="Follow Up: TietoEVRY: Kubernetes, 15. 04. 2021"
    header="Follow Up: TietoEVRY: Kubernetes"
    subheader="15. 04. 2021"
    hideNewsletter={true}
    markdown={`
## Materiály

### Repozitáře, které jsme použili

- Kubernetes - https://github.com/ondrejsika/kubernetes-training/
- Terraform - https://github.com/ondrejsika/terraform-training/
- ELK - https://github.com/ondrejsika/elk-training
- Prometheus - https://github.com/ondrejsika/prometheus-training

### Záznamy

- 1st day - https://www.youtube.com/watch?v=QZO3JKfrwyQ
- 2nd day - https://www.youtube.com/watch?v=i_crE-7bQM0
- 3rd day - https://www.youtube.com/watch?v=3_8LbVIwu9o
