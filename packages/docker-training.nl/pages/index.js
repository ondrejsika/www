...
import site from "@app/docker-training.nl/config";
import Link from "next/link";

const Index = () => (
  <div>
    <Head>
      <title>Docker Training, Ondrej Sika - docker-training.nl</title>
      <link
    ...
    <Header
      websiteHeader="Docker Training Netherlands 🇳🇱"
      byName="Ondrej Sika"
      byUrl="https://ondrej-sika.com/?x_source=docker-training.nl"
      logoUrl="/static/docker-w.svg"
    >
      <HeaderLink url="mailto:ondrej@sika.io?subject=[docker-training.nl] Docker Training Inquiry">
        Request a training
      </HeaderLink>
      <HeaderLink url="https://ondrej-sika.com/contact/?x_source=docker-training.nl">
        Contact me
      </HeaderLink>
    </Header>
...
`}
        ...
        <p className="text-center">
          {/* <Link href="https://ondrej-sika.com/training/docker/inquiry/?x_source=docker-training.nl">
            <a className="btn btn-large btn-success">Inquire Docker Training</a>
          </Link> */}
          <a
            href="mailto:ondrej@sika.io?subject=[docker-training.nl] Docker Training Inquiry"
