...
const Index = () => (
  <div>
    <Head>
      <title>Kuberneres Training, Ondrej Sika - training.kubernetes.is</title>
    </Head>
    ...
    >
      <HeaderLink url="https://ondrej-sika.com/is/training/kubernetes/inquiry/?x_source=training.kubernetes.is">
        Request training
      </HeaderLink>
        ...
        <TwoCol
          col1={
            <Markdown
              source={`
#### Skill Requirements
- Basic [Docker](https://ondrej-sika.com/is/training/docker/) knowledge
...
[Docker](https://ondrej-sika.com/is/training/docker)
`}
        />
      </TextFrame>
    </div>
